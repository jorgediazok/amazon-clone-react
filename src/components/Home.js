...
function Home() {
  return (
    <div className="home">
      ...
      <Product id="12321342" title="Kenwood kMix Stand Mixer for Baking. Stylish Kitchen Mixer with K-beater, Dough Hook and Whisk, 5 Litre Glass Bowl" price={239} rating={4} image="https://www.220-electronics.com/media/catalog/product/k/e/kenwood-kmix-kmx51-mixer--up.jpg" />
      </div>
      <div className="home__row">
      ...
      <Product id="12321344" title="Amazon Echo(3rd Generation) | Smart speaker with Alexa, Charcoal Fabric" price={98.99} rating={3} image="https://lh3.googleusercontent.com/proxy/HfKtv7Bu_kCiIhGqqMzJ_QVdPPzc3MgHgA4G4Rd6QvQ1Th9Kmqkpoi8NdIeihkooWb7MOCtF2cuK01PtTt6yZF17t7fdjQ2WaMGv77FlASc_-UGT0VJwRZ8sirYezMhiMYs" />
      <Product id="12321345" title="New Apple Ipad Pro | With the latest technology of Apple." price={399.99} rating={5} image="https://assets.kogan.com/files/product/etail/Apple-/KHIPP1291864CSIL_1.jpg?auto=webp&canvas=753%2C502&fit=bounds&height=502&quality=75&width=753" />
      </div>
      <div className="home__row">
